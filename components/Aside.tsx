...
const Aside: React.FC<AsideProps> = ({ className, posts }) => {
  ...
  const arrowTopRight = (
    <svg className="fill-neutral-900 dark:fill-neutral-100 h-3 ml-2" viewBox="0 0 7.82 7.82">
      <g>
  ...
  return (
    <aside className={className}>
      ...
      <div>
        <h2 className="font-black font-display text-duchs-900 dark:text-duchs-100 text-xl">LINKS</h2>
        <Link href="/feed.xml">
        ...
        <Link href="https://github.com/SogoKato/sogokato.github.io">
          <a className="block mb-1 hover:opacity-75 transition-all" target="_blank">
